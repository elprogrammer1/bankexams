...
<div class="row info">
    ...
    <div class="col-xs-3" style="float: right;padding: 0">
        <input min="0" step="0.5" placeholder="0" type="number" value="0" id="payed"
    ...
    <button class="col-xs-2 btn btn-success" id="finsh-bill-sales" style="float: right;height: 35px;"><?= $text_finsh ?>
    </button>
