...
class Messenger
{
    const APP_MESSAGE_SUCCESS = 'alert alert-success';
    const APP_MESSAGE_ERROR = 'alert alert-danger';
    const APP_MESSAGE_WARNING = 'alert alert-warning';
    const APP_MESSAGE_INFO = 'alert alert-info';
